...
export const breakdowns = pgTable("breakdowns", {
  ...
  capaWhy2Check: text("capa_why_2_check"),
  capaWhy3: text("capa_why_3"),
  capaWhy3Check: text("capa_why_3_check"),
  capaWhy4: text("capa_why_4"),
  capaWhy4Check: text("capa_why_4_check"),
  capaWhy5: text("capa_why_5"),
  capaWhy5Check: text("capa_why_5_check"),
  capa4M: text("capa_4m"), // Category: Design faults, Lack of preventive maint, etc.
